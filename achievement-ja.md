...
* [報道](#section-12)
* [ソフトウェア](#section-13)
	* [自身で研究開発したソフトウェア](#section-13-1)
	* [研究開発に関わったソフトウェアやリソース](#section-13-2)
...
1. <u>Takeshi Morita</u>, Kodai Nakamura, Hiroki Komatsushiro, Takahira Yamaguchi, "PRINTEPS: An Integrated Intelligent Application Development Platform based on Stream Reasoning and ROS", The Review of Socionetwork Strategies, Springer (2018) DOI: [10.1007/s12626-018-0020-y](https://doi.org/10.1007/s12626-018-0020-y)
...
1.	<u>森田武史</u>, "Wikipediaを活用したセマンティックWebコンテンツの半自動構築およびWeb APIの実装", 電気通信普及財団研究調査報告書(CD-ROM)  Vol. 26 pp.503-530 (2011)
...
# <a id="section-13">ソフトウェア</a>

## <a id="section-13-1">自身で研究開発したソフトウェア</a>
